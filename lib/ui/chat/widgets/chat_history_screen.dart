  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      widget.viewModel.loadSessions().catchError((e) {
        if (mounted) ToastHelper.showError(context, UserStorage.l10n.loadSessionListFailed(e.toString()));
      });
    });
  }

  Future<void> _deleteSession(ChatViewModel vm, String sessionId, int index) async {
              ...
              : RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final title = session['title'] as String? ?? UserStorage.l10n.newChat;
                              ...
                              child: Row(
                                children: [
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            const SizedBox(width: 8),
                                            Text(
                                              UserStorage.l10n.messageCount(messageCount),
                                              style: TextStyle(
                                                fontSize: 12,
                                                color: const Color(0xFF94A3B8),
                                              ),
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () =>
                                        _deleteSession(vm, sessionId, index),
                                  ),
                                ],
                              ),
                            ),
