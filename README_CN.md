...
## 安装
- **App Store & Google Play**: ⏳ **敬请期待 (Coming Soon)**。iOS 版和 Android 版目前均在各大应用商店审核中。
- **Android 抢先版**: 你可以前往 [GitHub Releases](https://github.com/memex-lab/memex/releases) 下载最新的 Android APK 安装包体验。
- **从源码编译**: 如果你等不及商店过审，也可以直接[通过源码在本地编译安装](#开发)。
...
Memex 不只是一个笔记应用 — 它是一个让你能够在手机上构建自己 AI Agent 的平台。
